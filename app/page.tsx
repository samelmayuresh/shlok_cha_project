...
export default async function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-retro-bg p-4 pb-24 transition-colors duration-300">
            ...
            <header className="mb-8 border-b-4 border-retro-border pb-4 text-center bg-retro-paper p-4 shadow-retro">
                ...
                <div className="inline-block bg-retro-border text-retro-paper px-2 py-1 font-mono text-sm">
                    SYSTEM_READY... OK
                </div>
            </header>
            ...
            <section className="mb-8">
                <div className="bg-retro-secondary text-white border-4 border-retro-border p-6 shadow-retro relative overflow-hidden group">
                    ...
                    <div className="absolute -right-4 -bottom-4 text-9xl opacity-20 rotate-12 text-black transition-transform group-hover:rotate-6">
                        AI
                    </div>
                </div>
            </section>
            ...
            {/* Categories Grid */}
            <section className="mb-8">
                <div className="flex items-center gap-2 mb-4 border-b-2 border-retro-border pb-1">
                    <span className="w-3 h-3 bg-retro-border"></span>
